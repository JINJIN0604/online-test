          ...
          <div class="content-wrapper">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      ...
                      <small class="text-muted float-end">번호를 선택하고 제출버튼을 눌러주세요</small>
                    </div>
			...
			<div>
				<c:if test="${empty answer}">
					<h6>${test.testTitle}</h6>
					<form id="testForm" method="post" action="${pageContext.request.contextPath}/test/addPaper">
