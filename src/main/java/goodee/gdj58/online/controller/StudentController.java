...
public class StudentController {
	...
	public String addPaper(@RequestParam(value = "studentNo") int studentNo
		...
		return "redirect:/test/testListByStudent"; 
	}
	
	
	// 시험 상세보기
	@GetMapping("/test/testOneByStudent")
	public String getTestOne(Model model, HttpSession session
		...
		return "test/testOneByStudent";
	}
	
	// 시험 목록
	@GetMapping("/test/testListByStudent")
